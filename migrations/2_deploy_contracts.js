...
module.exports = function(deployer) {
  ...
  deployer.deploy(StakingTokens, web3.utils.toHex("1000000000000000000"), "StakingToken", "ST", {gas: 90000000});
  deployer.deploy(DistributionTokens, web3.utils.toHex("1000000000000000000"), "DistributionToken", "DT", {gas: 90000000});
  //deployer.deploy(Geyser,{gas: 90000000 });
