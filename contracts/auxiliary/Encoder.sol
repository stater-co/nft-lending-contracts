...
contract Encoder is DefaultCreateLoanMethod, HealthFactorCreateLoanMethod {
    ...
    function encodeLtvSetter(uint256 newLtv) external pure returns(bytes memory) {
    ...
    function encodeCreateLoanWithHealth(
        ...
        return abi.encodeWithSignature("createLoan((address,uint256,uint256[],uint256,uint16))", loan);
    }
