...
contract LendingMethodsContract is ERC721Holder, ERC1155Holder, Ownable {
    ...
    function setDiscounts(uint32 _discountNft, uint32 _discountGeyser, address[] calldata _geyserAddressArray, uint256[] calldata _staterNftTokenIdArray, address _nftAddress) public payable {
