...
contract StaterProxy is ProxyCore, StaterProxyAdmin {
     ...
     */
    function vanillaCall(address to, bytes calldata input)
        external
        guarded(to)
     ...
     * @param input: Represents the method payload encoded as bytes
     */
    function delegateCall(address to, bytes calldata input)
        external
        guarded(to)
    {
    ...
    function _delegatecall(address to, bytes calldata payload)
        internal
        returns (bytes memory)
    {
    ...
    function _call(address to, bytes calldata payload)
        internal
        returns (bytes memory)
    {
