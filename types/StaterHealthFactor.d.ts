...
interface StaterHealthFactorInterface extends ethers.utils.Interface {
  functions: {
...
export class StaterHealthFactor extends Contract {
  ...
  interface: StaterHealthFactorInterface;
  ...
  functions: {
    ...
    "editLoan(uint256,uint16,uint256)"(
      loanId: BigNumberish,
      nrOfInstallments: BigNumberish,
      installmentTime: BigNumberish,
      overrides?: Overrides
    ...
    "getLoanAssetsValue((address,uint256,uint256[],uint256,uint16))"(
      loan: {
        currency: string;
        installmentTime: BigNumberish;
        nftTokenIdArray: BigNumberish[];
    ...
    iltv(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
    ...
    liquidationTreshold(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
    ...
    "setGlobalRouteVariables(address[],bool[])"(
      _whitelistedCurrencies: string[],
      _status: boolean[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;
    ...
    uniswapV3NftAddress(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
