...
interface LendingCoreMethodsInterface extends ethers.utils.Interface {
  functions: {
...
export class LendingCoreMethods extends Contract {
  ...
  interface: LendingCoreMethodsInterface;
