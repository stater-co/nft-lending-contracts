...
export interface LendingMethodsInterface extends utils.Interface {
  ...
  functions: {
    ...
    "closeOffer(uint256,uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "closeOffer", data: BytesLike): Result;
...
export interface LendingMethods extends BaseContract {
  ...
  functions: {
    ...
    "approveLoanOffer(uint256,uint256)"(
      loanId: BigNumberish,
      offerId: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
